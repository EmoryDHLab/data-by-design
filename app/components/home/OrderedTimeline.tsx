...
export default function OrderedTimeline({
  ...
  useEffect(() => {
    ...
    const selectedImageSelector = `img[src="/_static/images/${selectedImage.chapter}/${selectedImage.fileName}.jpg`;
            ...
            {images.map((image, index) => {
              ...
              return (
                <img
                  ...
                  src={`/_static/images/${image.chapter}/${image.fileName}.jpg`}
                  alt={image.altText ?? ""}
                />
              );
            })}
