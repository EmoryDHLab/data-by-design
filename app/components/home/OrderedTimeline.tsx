            ...
            {images.map((image, index) => {
              ...
              return (
                ...
                >
                  <picture>
                    <source
                      srcSet={`https://iiif.ecds.io/iiif/3/dxd%2f${image.chapter}%2f${image.fileName}.tiff/full/300,/0/default.png`}
                      type="image/webp"
                    />
                    <source
                      srcSet={`https://iiif.ecds.io/iiif/3/dxd%2f${image.chapter}%2f${image.fileName}.tiff/full/300,/0/default.jpg`}
                      type="image/jpeg"
                    />
                    <img
