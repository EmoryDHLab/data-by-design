        ...
        <nav className="bias-full w-full md:bias-1/2 md:w-2/5 relative self-center">
          <ul className="my-8 w-9/12">
            <li className="my-4">
              <button
                className={`${
                  currentChart === "original" ? "bg-powerSecondary" : "bg-white"
                } cut-corners p-2 uppercase font-power md:mx-2 text-sm md:text-base w-full`}
            ...
            <li className="my-4">
              <button
                className={`${
                  currentChart === "one" ? "bg-powerSecondary" : "bg-white"
                } cut-corners p-2 uppercase font-power md:mx-2 text-sm md:text-base w-full`}
            ...
            <li className="my-4">
              <button
                className={`${
                  currentChart === "two" ? "bg-powerSecondary" : "bg-white"
                } cut-corners p-2 uppercase font-power md:mx-2 text-sm md:text-base w-full`}
            ...
            <li className="my-4">
              <button
                className={`${
                  currentChart === "three" ? "bg-powerSecondary" : "bg-white"
                } cut-corners p-2 uppercase font-power md:mx-2 text-sm md:text-base w-full`}
