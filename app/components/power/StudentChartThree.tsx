...
import responseData from "~/data/power/studentResponses.json";
    ...
    >
      ...
      >
        ...
        <text
          ...
          y={90}
          textAnchor="middle"
          className="text-black font-powerWide uppercase tracking-wider"
        >
        ...
        <text
          ...
          textAnchor="middle"
          className="uppercase font-powerWide tracking-wider"
        >
        ...
        <text
          x={leftMargin}
          className="uppercase font-powertWide tracking-wider"
          fontSize={regularText}
          y={865}
        >
      ...
      {!interactive && (
        <g>
          <image
            href="/images/power/1910-survey-cover.jpg"
          ...
          />
          <image
            href="/images/power/1910-survey-p1.jpg"
            className={`w-full transition-opacity duration-1000 opacity-${
