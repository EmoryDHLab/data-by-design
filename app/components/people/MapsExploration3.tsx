...
export default function ImageTooltips() {
  ...
  const tooltips = [
    ...
    },
    {
      ...
      y: 51,
      title: "1818",
      description: "Observation from lookout tree (before ship incident)t",
    },
    {
      id: 3,
      x: 52.6,
    ...
    },
    {
      ...
      y: 46.7,
      title: "~1819-1914",
      description: "Peyton learns about the lookout tree",
    },
    {
      id: 7,
      x: 46.4,
    ...
    },
    {
      ...
      y: 66,
      title: "1914",
      description: "Speck photographs tree",
    },
    {
      id: 11,
      x: 63,
      y: 66,
      title: "1914",
      description: "Speck climbs other lookout tree at Red Indian Point",
    },
    {
      id: 12,
      x: 63,
    ...
    },
    {
      ...
      y: 31.7,
      title: "2021",
      description: "LK sees photo of tree",
    },
    {
      id: 19,
      x: 84.8,
    ...
    },
    {
      ...
      y: 8.1,
      title: "2024",
      description: "LK sees clouds in St. John’s",
    },
    {
      id: 23,
      x: 91,
      y: 34.5,
      title: "2025",
      description: "We interpret photograph for this chapter",
    },
    {
      id: 24,
      x: 91,
