  ...
  return (
    <>
      <p className="font-bold text-lg md:text-xl 2xl:text-2xl text-center font-duboisWide uppercase">
        A STATISTICAL CHART ILLUSTRATING INFORMATION ABOUT THE GRADUATES OF
        ATLANTA UNIVERSITY WHO CONTRIBUTED TO DU BOIS'S RESEARCH.
      </p>
      ...
      <div className="mt-6 font-dubois uppercase text-center">
        ...
        <p>
          The 1898-1899 Catalogue lists these same graduates by name, along with
          their degree(s) earned, current occupation, and place of residence.
        </p>
      </div>
      ...
      <div className="mx-4 md:mx-auto font-dubois uppercase text-justify tracking-wider">
        <p>
          This visualization honors the Atlanta University students who helped
          to create Du Bois's original chart, as well as those whose lives were
          behind the data. The original chart depicted the occupations of the
          graduates of Atlanta University as of 1898 as percentages. Here, the
          name of each graduate is placed in the appropriate area of the chart.
        </p>
        <p>
          Several graduates are positioned outside of the chart, closest to the
          occupations that they would soon take on. These are William Andrew
          Rogers of the Class of 1899, the only formally recognized contributor
          to the original set of charts; and the four students enrolled in Du
          Bois's advanced sociology course during the 1899-1900 academic year,
          Henry Napoleon Lee, Lula Iola Mack, Edward Lee Simon, and William
          George Westmoreland, who most likely collected, analyzed, and
          visualized the data depicted in the original charts.
        </p>
      </div>
    </>
  );
