      ...
      >
        ...
        >
          <div className="sticky p-3 md:p-0 top-20 h-min bias-full w-full md:bias-1/2 md:w-7/12 md:order-last">
            ...
            <p className={`font-bold text-sm md:text-sm xl:text-sm text-center font-duboisWide leading-3 uppercase opacity-${
                  opacity
                }`}>
                 
              A STATISTICAL CHART ILLUSTRATING INFORMATION ABOUT THE BLACK COLLEGE GRADUATES FROM
            ...
            <p>
                The previous chart visualized graduates of Atlanta University. In 1910,
                Du Bois and his students undertook a larger study of Black college
                graduates across the United States.
              </p>
              <p>
                This chart visualizes information about the graduates of Atlanta University
                who were included in the 1910 study, <cite>The College-Bred Negro American</cite>.
              </p>
            </div>
            ...
            <div className="mx-4 md:mx-auto font-dubois uppercase text-justify tracking-wider">
              <p>
                This visualization honors the 3,856 Black college graduates from across the
                United States whose lives were included as data in the The College-Bred Negro
                American. A subset of these graduates, whose names remain unknown, contributed
                additional research to the study in the form of data collection and analysis.
              </p>
              <p>
                In this chart, each graduate of Atlanta University as of 1909, with a known occupation,
                is positioned in the appropriate area of the chart. Additional categories represent
                those with unknown occupations and those recorded as “Deceased.” An additional 3,693
                dots represent the graduates of the other 140 colleges included in the study whose names
