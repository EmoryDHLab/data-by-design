  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap font-duboisNarrow text-base text-md text-center uppercase md:mt-8">
        ...
        <div className="md:w-2/3">
          ...
          <p className="md:mt-8">
            ...
            American, these same 3856 Black college graduates were surveyed
            about their lives. This chart visualizes their words.
          </p>
        </div>
        ...
        >
          <g>
            ...
            >
              ...
              <tspan dy={4} x={150} fontFamily="VTC Du Bois Narrow, serif">
      ...
      <p className="mx-4 md:mx-auto font-dubois uppercase text-justify tracking-wider">
        ...
        the 3856 Black college graduates whose lives were recorded as data in
        the Atlanta University Study of 1910, entitled The College-Bred Negro
        ...
        included four questions that encouraged long-form response: their
        thoughts on their own “early life and training,” their plans to educate
        their children, the “chief hindrances” they had faced, and their
        “present practical philosophy in regard to the Negro race in
        America”--abbreviated in the published study as “philosophy of life.”
        About 800 responses to the survey were received; these are the responses
