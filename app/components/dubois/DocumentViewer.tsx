        ...
        <div className="py-10 px-5 flex flex-col items-center w-1/6 space-y-5">
          ...
          >
            {selectedSet === "setOne" ? (
              <div className="space-y-5 max-w-[70px]">
                <img
                  src="/_static/images/ui/stack1.png"
                  alt=""
                  role="presentation"
                />
                <img
                  className="w-full"
                  src="/_static/images/ui/set1.png"
                  alt=""
                  role="presentation"
                />
              </div>
              ...
              <div className="space-y-5 max-w-[70px]">
                <img
                  src="/_static/images/ui/eyeframe.png"
                  alt=""
                  role="presentation"
                />
                <img
          ...
          >
            {selectedSet === "setTwo" ? (
              <div className="space-y-5 max-w-[70px]">
                <img
                  src="/_static/images/ui/stack2.png"
                  alt=""
                  role="presentation"
                />
                <img
                  className="w-full"
                  src="/_static/images/ui/set2.png"
                  alt=""
                  role="presentation"
                />
              </div>
            ...
            <div className="flex text-white justify-around w-full">
              ...
              >
                <img
                  ...
                  src="/_static/images/ui/leftarrow.png"
                  alt=""
                  role="presentation"
                />
              </button>
              ...
              >
                <img
                  className="w-[27.5px] h-[19.5px] mt-5"
                  src="/_static/images/ui/rightarrow.png"
                  alt=""
                  role="presentation"
                />
              </button>
