...
export default function PeabodyBarGraph() {
  ...
  const [currentCenturyEvents, setCurrentCenturyEvents] = useState(getCenturyEvents(centuries[2]));
  ...
  return (
    <BarGraphContext.Provider value={{
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 bg-black gap-x-0 md:gap-x-32 md:gap-y-2 text-white text-center w-full p-6">
        ...
        <div className="w-full col-span-2 grid grid-cols-1 gap-0 mt-1 pb-6">
        ...
        <div className="text-left w-full mx-auto col-span-2 md:col-span-1 ml-0 md:ml-6">
          <h3 className="mb-6 text-xl md:text-3xl">Visualizing Time</h3>
          <h4 className="mb-6 text-base md:text-2xl">The Peabody Chart as Bar Graph</h4>
          <CenturySelect />
        </div>
        <div>
          <Key />
