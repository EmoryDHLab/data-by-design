  ...
  return (
    ...
    >
      ...
      >
        ...
        <tspan x={200} dy={12}>at the beginning.</tspan>
      </text>
      ...
      >
        <tspan>Number of people</tspan>
        <tspan x={200} dy={12}>at the end.</tspan>
      </text>
      ...
      >
        <tspan>If the</tspan>
        <tspan x={10} dy={12}>duration of</tspan>
        <tspan x={10} dy={12}>the voyage is</tspan>
        <tspan x={10} dy={12}>+++ then the</tspan>
        <tspan x={10} dy={12}>amplitude</tspan>
        <tspan x={10} dy={12}>increases</tspan>
      </text>
