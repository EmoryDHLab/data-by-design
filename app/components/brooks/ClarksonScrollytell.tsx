      ...
      >
        ...
        >
          <div className="mb-6">
            <div className="w-11/12 mx-auto">
              <svg
                ...
                className={`w-full transition-[height] duration-1000 ${
                  scrollProgress >= 13.5 ? "h-[80vh]" : "h-[50vh]"
                }`}
              >
                <image
                  href="/_static/images/brooks/4-description-1789.jpg"
            ...
            <div
              className={`text-3xl relative md:bottom-0 ml-4 text-black hidden md:${
                scrollProgress >= 13.5 ? "hidden" : "block"
              }`}
              tabIndex={-1}
            >
              ↓
          ...
          {triggers.map((trigger, index) => {
            return (
              <div
                ...
                data-step={index}
                className={`pointer-events-none step text-xl content-center p-5 md:px-20 relative h-${
                  index == 8 ? "[50vh]" : "screen"
                } text-${accentTextColor}`}
              >
                <p
                  className={`bg-${
                    index != 8 ? "brooksSecondary-translucent" : ""
                  } p-3 md:p-12 w-9/12`}
                >
                  {trigger}
                </p>
