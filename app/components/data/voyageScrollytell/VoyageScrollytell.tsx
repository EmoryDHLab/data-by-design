      ...
      <div className={`sticky h-screen top-24`}>
        <div className="grid grid-cols-2 justify-items-center">
          ...
          <div className="h-3/4 w-3/4 my-auto">
            ...
            >
              <Picture
                figure={figures["fisk-plate22sheet09"]}
            ...
            >
              <Picture
                figure={figures["equiano-narrative"]}
        ...
        >
          ...
          <div className="absolute top-28 text-center w-screen mx-auto font-power text-xl">
            <span className="bg-offwhite py-6 px-16">Begin Voyage</span>
          </div>
          <div className="absolute bottom-64 text-center w-screen mx-auto font-power text-xl">
            <span className="bg-offwhite py-6 px-16">End Voyage</span>
          </div>
          <div className="absolute top-[40vh] left-32 text-center mx-auto font-power text-xl">
            <span className="bg-offwhite py-6 px-16">1565</span>
          </div>
          <div className="absolute top-[40vh] right-32 text-center mx-auto font-power text-xl">
