import p5 from "p5";
import { Circle } from "~/components/change/pieChart/Circle";
import { Label } from "~/components/change/pieChart/Label";
import { useEffect, useRef } from "react";
import { useDeviceContext, useResizeObserver } from "~/hooks";
import tailwindConfig from "tailwind.config";
import type { Student, StudentData } from "~/components/change/types";
...
function placeCategoryCircles(
  ...
  const extraCount = extra
    ? Math.floor(p5.map(students.length, 0, 163, 0, 3693))
    : 0;
