...
export default function BrooksPage() {
  ...
  const chapterContextValue = useMemo(
    ...
    [hoverState, hideSensitiveState, showFootnotes],
  );
      ...
      <ChapterBody>
        <CenteredLayout>
          ...
          <p className="first-paragraph">
            ...
            Kidnapped from his birthplace at the age of 11 and carried to the
            Atlantic coast, he was then forced aboard a slave ship. There
            Equiano encountered “a multitude of black people of every
            description chained together,” as he recalled in his autobiography.
            <InlineFootnote index={1} />
            He was taken to Barbados and then to Virginia, where he was sold.
            Equiano would remain enslaved for almost 20 years.
          </p>
          <p>
            ...
            coalesce, Equiano grew increasingly involved. Through this activism
            Equiano became acquainted with Thomas Clarkson, a leading white
            abolitionist and key member of the London Committee of the Society
            for Effecting the Abolition of the Slave Trade (SEAST).
            <InlineFootnote index={2} />
            Thus when, in early 1789, Clarkson received a copy of a diagram
            created by the Plymouth Committee of SEAST entitled “Plan of an
            African Ship’s Lower Deck with Negroes in the Proportion of Only One
            to a Ton,” he knew exactly whom he should ask to confirm the truth
            of what he saw.
          ...
          <p>
            ...
            But in the diagram that Clarkson received from the Plymouth
            Committee, and that he shared with Equiano, Clarkson believed he’d
            found the key to conveying the depth of this inhumanity to his white
            compatriots. The diagram, which Clarkson would go on to revise and
            extend, publishing it in March of that year as “Description of a
            Slave Ship,” would create an “instantaneous impression of horror
            upon all who saw it,” he later recalled, and would compel them to
          ...
          <p>
            ...
            As we learned in the introduction, the idea that quantitative
            information could be visualized as data, perceived by the eyes, and
            then processed into knowledge had been steadily coalescing from the
            earliest expressions of empiricist philosophy, and from an
            increasingly wide range of examples of how information could be
            abstracted into images that the eye could perceive.
          </p>

          <p>
            This intellectual genealogy in fact easily aligns with the standard
            story we tell about the origins of modern data visualization. But
            with the “horror” that Clarkson engineered his chart to produce, the
            expanded origin story of visualization—the one that includes its
            connections to colonialism and, as we will learn in this chapter,
            slavery—also enters the frame. This expanded origin story
            underscores its tremendous power to distill complex information such
            that insight can easily and efficiently emerge. At the same time, it
            ...
            produce this insight always, and <em>necessarily</em>, comes at the
            expense of additional detail.
          </p>
          <p>
            SEAST’s slave ship diagrams remind us that before there is data
            there are people—people who contribute to the production of data,
            and people who themselves become data, not always with consent. As
            we will see as this chapter unfolds, the act of transforming people
            into data, and of putting that data on display, are both acts of
            power. But that power is not guaranteed to be a benevolent force.
            Centering SEAST’s visualization work in the story we tell about data
            visualization is therefore long overdue, because it requires that we
            recognize the responsibility that comes with the power of
            visualizing data—the power to frame what it is possible to see, and
            thus to know.
          </p>
        </CenteredLayout>
        ...
        <CenteredLayout className="pb-20">
          <p className="first-paragraph">
            The original engraving Clarkson showed to Equiano is attributed to
            the Plymouth Committee as a collective, but is generally believed to
            have been designed by a single man: William Elford, the Committee’s
            chairman and a veritable polymath. A banker by trade, Elford was
            also an acclaimed painter who had shown at the Royal Academy of Arts
            and an amateur scientist who had been elected to the Royal Society,
            the highest scientific honor of the time.
          </p>
          <p>
            Supplementing this range of skills were both domain expertise and
            class privilege: Elford had family ties to the Royal Navy, and as a
            ...
            scrutinizing muster rolls—lists of crew members aboard any
            particular ship—Parrey also interviewed the captains and sailors of
            the ships themselves, learning otherwise undisclosed information
            about the perils faced by both captives and crew.
          </p>
          <p>
            The art historian Cheryl Finley, whose{" "}
            <cite>Committed to Memory</cite> explores the origins and evolving
            significance of these charts in detail, speculates that among the
            “most useful” artifacts from Parrey’s report were the hand-drawn
            ...
            the efficiency of packing ships,” these sketches, for their
            abolitionist viewers, likely became a graphic call to arms.
            <InlineFootnote index={9} />
            Elford, for one, saw a direct visual depiction of the dehumanization
            that was required in order to reduce human lives into commodity
            goods on the part of slavery’s profiteers.
          </p>
          <p>
            ...
            discussed in this chapter, until you could be more prepared for what
            you might see. We made this choice because of the range of harms
            that can be brought about by engaging with the archive of slavery
            without warning, context, or consent.
            <InlineFootnote index={10} />
            If you would now like to see Elford’s version of the diagram, you
            can do so by clicking the toggle at the bottom right of the screen.
            Or you may choose to continue to see the blurred-out images,
            accompanied by generalized descriptions of what the images show.
          </p>
          <p>
            As some of you have also already experienced, we provide a parallel
            choice for those of you who rely on alt-text to process visual
            media. In this case, the toggle at the top left of the page switches
            between generalized and detailed descriptions of the images. Both
            modes of encounter are informed by the concept of{" "}
            <em>progressive disclosure</em>, an idea formulated by Silas Munro,
            a member of our project team. By this he means a mode of
            presentation that gradually introduces individual elements of the
            most sensitive images included this chapter, so that the reader is
            not subjected to the same experience of visceral and immediate
            horror that SEAST intended with their charts. While this decision
            runs counter to the Society’s original goal, our encounter with
            these images over two hundred years after they were first shown
            serves a different purpose: to understand how the charts’ designers
            were able to leverage a combination of abstraction and detail in
            order to achieve their catalyzing effects.
          </p>
          <p>
            Even progressively disclosed, the diagrams remain as viscerally
            affecting as they are visually impossible. In the original Elford
            diagram—the one on the previous set of pages, and that Equiano
            saw—viewers see the ship from above, as if they are gods in the
            heavens. The top deck of the ship has been removed, so that the
            viewer can see directly into the hold. (Later we will return to this
            strategy of what is, in fact, a “god trick,” as feminist philosopher
            Donna Haraway describes.)
          </p>
        </CenteredLayout>
        ...
        <PlymouthCommitteeScrollytell
          triggers={[
            ...
            <span key="a400ea46">
              The largest, in the bow of the ship, and which occupies the entire
              right half of the diagram, is labeled the “Mens room,” and depicts
              120 men’s bodies in four rows of 24. Another 24 figures fit into
              the curved space closest to the front of the bow.
            </span>,
            <span key="e6184ce7">
              In the middle is a narrow area labeled “Boys room” which depicts
              shorter figures in five rows of 12.
            </span>,
            <span key="aebd268b">
              ...
              four rows of 21, representing 84 women in total.
            </span>,
            <span key="b1f566ad">
              At the stern is the “Girls Room,” the figures shorter and squatter
              than the boys, arranged in three rows of 10.
            </span>,
            <span key="d90523c5">
        ...
        <TwoColumnLayout>
          <Column shouldPin={true}>
            <p>
              ...
              by the ship’s owner to commemorate the “successful” return of its
              first slaving voyage, presents{" "}
              ...
              Beside a table breaking down counts of various “items of trade”
              sits another, in near-identical form, labeled “Products of
              Loango.” The numbers here refer to people, sorted by gender and
              age and whether or not they survived the voyage.
            </p>

            <p>
              This visual presentation of people as data—a literal headcount, as
              project team member Margy Adams has observed—reinforces the claims
              made by historians of slavery, such as Jessica Marie Johnson, that
              data itself “is the evidence of terror, and the idea of data as
              fundamental and objective information … obscures rather than
              reveals the scene of the crime.”
              <InlineFootnote index={13} />
              Unlike the “cartoon figures” in Elford’s diagram, as Spillers
              describes them, the captives in this image are each individually
              drawn.
              <InlineFootnote index={14} />
              They are shown lying on their sides.{" "}
              ...
              shackled two by two.{" "}
              <HoverText hoverState="nursingMother">One woman</HoverText> nurses
              a child.
            </p>

            <p>
              Whether or not Elford saw this particular “Plan,” he clearly
              considered what he would give visual form—and also what he would
              not. In contrast to the diagram of the Marie Séraphique, the two
              areas of Elford’s diagram labeled “store room” are left blank,
              even as they were presumably similarly packed with{" "}
              ...
              important than the packing of <em>people</em> as cargo on these
              ships.
              <InlineFootnote index={15} />
            </p>
            <p>
              At the same time, Elford could not but participate in this process
              of dehumanization, however inadvertently. A large part of how the
              diagram achieves its visual impact is the way its 294 human souls
              are drawn as nearly identical figures—what literary scholar Marcus
              Wood describes as a “mass of black human flesh.”
              <InlineFootnote index={16} />
              The figures’ collective rather than individual significance is
              further accentuated by their being set against the clean outlines
              of the ship.
              <InlineFootnote index={17} />
              The labels associated with each area, engraved in neat script,
              accentuate this reduction in complexity—which is, of course, a
            ...
            <p>
              ...
              In so doing, he “induce[s] the viewer to think about the
              substance” of the data of the slave trade, to employ Edward
              Tufte’s language of graphical excellence, rather than specific
              people on specific ships.
              <InlineFootnote index={19} />
              Yet Elford achieves his visual tour de force by stripping away the
              individual lives behind each datapoint—the lives that,
              paradoxically, he designed his charts in order to support.
            </p>
            <p>
              What should we do about this unavoidable tension, either as
              viewers of visualizations or as designers of them? The answer is
              not that we should reject visualization out of hand. It is,
              rather, that we must always consider what is lost in the process
              of visualizing data at the same time as we consider what is
              gained.
            </p>
            <PullQuote
            ...
            />
            <p>
              “Plan of an African Ship’s Lower Deck” also reminds us, with its
              subject most profound, that there are always aspects of human
              experience that visualization cannot convey. No diagram can ever
              express the full extent of the brutality and degradation that was
              required to enforce the enslavement of otherwise equals. No
              diagram can ever fully communicate the “horror almost
              inconceivable”—to return to Equiano’s chilling words—to those who
              did not personally experience it; nor can any diagram
              appropriately convey the additional trauma that others, like
              Cugoano, chose to keep suppressed. But the lesson, here, is not of
              the futility of visualizing data. It is, rather, one of hope: that
              with the image of the slave ship indelibly etched in our minds, we
              will keep both the power and limits of data visualization together
              in view.
            </p>
            <p>
              The power to produce an “instantaneous impression” remains among
              visualization’s greatest strengths—what Fernanda Viégas, who
              created the “Wind Map” that appears in this book’s introduction,
              calls its “superpower.”
              <InlineFootnote index={20} />
              But just as we consider that power, we must also consider our
              responsibility for the insights that our visualizations produce,
              as we do for the detail and context—and in this case, the
              lives—that visualizations on their own cannot convey.
            </p>
          </Column>
          <Column shouldPin>
            <SeraphiqueTour figure={figures["0104-marieseraphique"]} />
          </Column>
        </TwoColumnLayout>
        ...
        <CenteredLayout>
          <p>
            ...
            elicit a combination of sympathy and shock. The desired result was
            that the viewer would perceive the “inhumanity of the trade” through
            the eyes and the heart at the same time and, prompted by the
            “instantaneous impression” that it made on the senses, be compelled
            to act.
            <InlineFootnote index={28} />
          </p>
          <p>
            At this point, one previously unstated detail must now be made
            explicit: these viewers, like the captives, had a race. They were
            white, predominantly British and predominantly men, with lives far
            removed from the experience of enslavement. In fact, Clarkson had an
            even more specific audience in mind: the members of the British
            Parliament, scheduled to vote on a motion to abolish the slave trade
            in several weeks’ time. One of the London Committee’s own members,
            William Wilberforce, was among them, and he believed, and said as
            much, that if the MPs “could actually <em>see </em>one thousandth
            part of the evils of that practice which they have, for so many
            years, under one pretense or another, been prevailed on to suffer to
            be continued,” they would quickly commit themselves to the
            abolitionist cause.
            <InlineFootnote index={29} />
          </p>
          <p>
            Here is where we return to the idea of the “god trick,” mentioned at
            the outset of this chapter. The “god trick” is an idea developed by
            Donna Haraway to describe the false sense of neutrality conveyed
            through the default perspective of data visualization, the “view
            from above.”
            <InlineFootnote index={30} />
            The view from above can seem godlike, but it is a “trick” because it
            preys upon our general tendency not to notice, let alone question,
            any perspective that adheres to the default. In this particular
            case, the seemingly godlike perspective is, in fact, the perspective
            of “predominantly white and male abolitionists and lawmakers,” as
          ...
          <p>
            ...
            celebrated how his chart “brought forth tears of sympathy in behalf
            of the sufferers, and it fixed their sufferings in [the viewer’s]
            heart.”
            <InlineFootnote index={32} />
            But Browne’s analysis of “the primacy given in these abolitionist
            texts to white gazes and vantage points to the trauma of slavery,”
            pushes us, as twenty-first-century viewers, to see even more.
          ...
          <p>
            ...
            commitment to accurate representation, he could not help depicting
            the captives’ resistance, in ways both large and small? These
            ...
            Middle Passage from the perspective of the captives themselves? What
            new knowledge, if any, might this visualization bring to light? And
            for whom might this, instead, further perpetuate harm?
          </p>
        </CenteredLayout>
        ...
        <CenteredLayout>
          <p className="first-paragraph">
            ...
            a full download of the transatlantic portion of the Voyages
            Database, which (as of spring 2026) contains records of 36,150
            unique slaving voyages that took place between the years 1514 and
            1866, resulting in the captivity and forced migration of an
          ...
          <p>
            Ever since the first release of the database, in 1999 via CD-ROM,
            scholars and designers have attempted to give this powerful data
            visual form.
            <InlineFootnote index={36} />
            Perhaps most prominently, in 2016, Andrew Kahn and Jamelle Bouie
            produced an animated visualization of the data for{" "}
            <cite>Slate</cite>, the online magazine, which depicted each of the
            20,528 voyages then in the database as small black dots seemingly
            pulled from the west coast of Africa to the Americas as if by
            magnetic force.
            <InlineFootnote index={37} />
            The visualization was roundly critiqued by scholars of slavery for
            the god’s-eye perspective that it adopts. As literary scholar Britt
            Rusert asserts, “It’s as if a series of ‘invisible hands’ operate
            the trade,” rather than specific people who should be condemned for
            their acts.
            <InlineFootnote index={38} />
            Although she does not formulate her critique in these exact terms,
            what Rusert identifies is another version of the “god trick” at
            work.
            <InlineFootnote index={39} />
          </p>
          <p>
            Reflecting on this visualization, as we considered whether a
            different depiction of the Middle Passage might be possible, enabled
            us to clarify our task. We first considered the provenance of the
            dataset, and contemplated how the shipping logs and other data
            tables that served as its primary sources—like the table associated
            with the plan of the <cite>Marie Séraphique</cite>—were created by
            the enslavers and not the enslaved. This reminded us of the power
            relations embedded in the data, and of how that power contributed to
            a range of omissions and gaps. We also considered our own subject
            positions, and the fact that, among the five of us collaborating on
            this particular visualization, only one of us was connected to
            ...
            about the data that were not ours to tell, and, following scholar of
            slavery Saidiya Hartman, should be left for others to convey.
          </p>
          <p>
            Finally, we returned to Jessica Marie Johnson’s powerful statement,
            in her “Markup Bodies” essay, that “there is nothing neutral, even
            in a digital environment, about doing histories of slavery.”
            <InlineFootnote index={40} />
            This called us back to the range of harms that can be brought about
            by engaging with this history, as discussed earlier in this chapter,
            and to how data visualization is not immune. We saw the potential
            for “second-order violence,” as Hartman terms it, both in
            reanimating a dataset that in its original form conscribed the
            people it represented to living death, and in controlling the layout
            and motion of data documenting the forced migration of so many. In
            order to better represent the enslaved as they lived, and not
            further reinforce how they were reduced to data, we would need a
            visual strategy that could draw out meaningful facets of the dataset
            while simultaneously reinforcing just how much about each life the
            data could not show.
          ...
          triggers={[
            ...
            <span key="d4c5b977">
              ...
              <span className="block">
                Shiyao Li, the primary computer science researcher on our team,
                had the idea to call these rivulets “binds,” since what they
                represented was not the freedom of movement that comes with
                flowing water, but its opposite: a form of bondage often
            ...
            <span key="f754f6ea">
              <span className="block mb-8">
                ...
                plot these voyages alongside the “resistance” voyages, further
                troubling the distinction between the voyages that included
                documented acts of resistance and those that did not.
              </span>
              <span className="block mb-8">
                With these additional voyages plotted, distinguished from the
                others by their lack of color fill, we observed a visual
                transformation that we had not intended, but that aligned with
                our conceptual goals: the binds were transformed into
                life-affirming arteries, enclosed within the sinews of human
                flesh.
                <InlineFootnote index={46} />
              </span>
              <span className="block">
                As evocative as this visualization may be, there are many other
            ...
            <span key="8f72225a">
              <span className="block mb-8">
                ...
                identity and his Ibo roots, he explains, “I refused to answer to
                my new name.”
              ...
              <span className="block">
                ...
                meaningful, even as they remain difficult to represent as data
                at all.
            ...
            <span key="cdd173c9">
              <span className="block mb-8">
                ...
                providing an overview first, and then “details on demand,” our
                visualization inverts this process. We begin with the details of
                the “resistance” voyages, but as the additional voyages are
                layered in, the viewer can no longer see clearly enough to
                deduce anything about a specific voyage.
              </span>
              <span className="block">
                This is intentional, because the insight that we seek to prompt
                exceeds the data on display. Our insight is this: that there are
                certain phenomena, such as the trauma of the Middle Passage,
                that we—in the present—can never fully understand.
              </span>
            </span>,
          ]}
        />
        ...
        <CenteredLayout>
          <p className="first-paragraph">
            ...
            formally abolish the slave trade—and, according to the Voyages
            ...
            Clarkson himself likely contributed to this narrative; in 1808, one
            year after the formal Act of Parliament, he published a celebratory
            two-volume tome,
            <cite>
          ...
          <p>
            ...
            were four images. Among them were a revised version of “Description
          ...
          <p>
            ...
            trade. Marcus Wood questions Clarkson’s “strange reversal” of an
            otherwise easily interpretable visual metaphor—flowing water—which,
            in Clarkson’s hands, seems to suggest that the success of the
            movement should be attributed not to any human actor but instead to
            a “mysterious sea.”
            <InlineFootnote index={52} />
            The water metaphor is further clouded by the role that actual
            water—namely, the Atlantic Ocean—played in the slave trade. Why
            would Clarkson use the ocean—the very site of the dehumanization
            that was required of the condition of enslavement—as the anchoring
            metaphor of his abolitionist chart?
          </p>
          <p>
            ...
            visually represent the passage of time. In{" "}
            ...
            ideas expressed by the German chronologer Friedrich Strass, who had
            published his own widely circulated “Strom der Zeiten” (Stream of
            Time) only a few years earlier, in 1803.
            <InlineFootnote index={53} />
            Widely circulated across Europe and the United States, “Strom der
            Zeiten” was almost certainly a chart that Clarkson saw. Even if not,
            he clearly intuited how the water metaphor “gives greater liveliness
            to the ideas, and impresses events more forcibly on the mind, than
            the stiff regularity of the straight line,” as William Bell, the
            English translator of Strass’s chart, explains.
        ...
        <CenteredLayout>
          ...
          <p>
            ...
            This argument is confirmed by the purported “pioneer” of statistical
            graphics himself, William Playfair, the subject of the next chapter,
            who praised the genre for “making space represent time,” and for
            using “a line of proportional length and in a suitable position.”
            <InlineFootnote index={56} />
            As we will learn, Playfair described the purpose of his own
            visualizations in terms quite similar to Clarkson’s: to unite “a
            number of separate ideas … under one simple impression of vision,
            and consequently, one act of memory.”
            <InlineFootnote index={57} />
          </p>
          <p>
            But to simply slot Clarkson into the standard history would miss
            this chapter’s point: his visualizations matter for the questions as
            much as the insights they prompt. When we ask about the perspectives
            of the people for whom these charts have been designed, the people
            who will benefit from looking at them, and the people who are merely
            looked at, we begin to see whose data is truly on view in any
            particular chart. And when we consider that additional context, and
            the potential for violence or harm, that a visualization might,
            however inadvertently, bring about, we come to see the
            responsibility that we hold as viewers of data visualizations—and as
            designers of them as well.
          </p>
          <p>
            We will never know if Equiano posed questions like these to Clarkson
            upon seeing the original “Plan”; there is no record of the contents
            of the conversation that transpired. Several weeks later, however,
            Equiano published a letter in <cite>The Public Advertiser</cite>, a
            prominent London newspaper, in which he acknowledged “having seen”
            the Plymouth Committee’s chart.
            <InlineFootnote index={58} />
            Equiano does not comment directly on the image, choosing instead to
            affirm the abolitionist movement overall. But I believe that we can
            still learn from his statement about what he saw. By offering his
            statement, Equiano confirms that he saw clear evidence that the
            chart’s designers sought to “contribute to so important a moral and
            religious duty as that of” ending the slave trade. But he also
            communicates his belief that the chart alone would not be enough to
            complete the task. As a person who had himself been enslaved,
            Equiano understood firsthand that ending “one of the greatest evils
            now existing on earth” would require more than a single chart.
          </p>
          <p>
            With this statement we return to this chapter’s epigraph: before
            there is data, there are people, with lives that data alone cannot
            convey. Equiano’s story lets us see, too, that if the goal of a
            visualization is to bring about change, it must necessarily be
            accompanied by action. We will return to this topic in the chapters
            to come, as we consider the ways that design processes (chapter 3)
            and design outputs (chapter 5) can better serve the people whose
            struggles for justice and dignity we seek to support. Here, however,
            we seek to make a broader point, since not all visualizations are
            designed with a goal of liberation in mind, and that is perfectly
            fine. Placing the SEAST diagrams at the center of the story we tell
            about the emergence of modern data visualization matters in these
            other contexts as well—and perhaps even more. For the SEAST diagrams
            do not ask but <em>demand</em> that we recognize the responsibility
            that comes with designing and viewing data visualizations. By
            attempting to picture the most monumental of humanity’s stakes, the
            SEAST diagrams serve as a constant reminder to always ask about the
            forms of knowledge that a visualization can illuminate—and what it
            cannot show.
          </p>
        </CenteredLayout>
        <Takeaways
          ...
          forViewers={[
            <span key="75cf526a">Reckon with the power of visualization</span>,
            <span key="6d2691fc">
