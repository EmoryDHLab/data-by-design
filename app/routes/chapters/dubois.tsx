        ...
        <div className="grid-wrapper bg-offwhite py-16 text-xl">
          ...
          <div className="flex flex-col items-center middle-full full-bleed py-16">
            ...
            <div className="font-william text-center mt-10 w-5/6">
              <p>
                ...
                >
                  Above: “Distribution of African American inhabitants of the
                  7th Ward,” the central image of{" "}
                </span>
                <span
                ...
                >
                  ...
                  Du Bois administered social surveys and collected the other
                  data that would culminate in the report. Image courtesy of
                  Wikimedia Commons.
                </span>
              </p>
            </div>
          ...
          <p>
            ...
            <span className="font-normal">
              ...
              Census, in order to put the Black population of the United States
              in national and international perspectives. Throughout both series
              of charts, Du Bois underscores the vitality of the nation’s Black
          ...
          <p>
            ...
            <span className="font-normal">
              ...
              how to visualize them, Du Bois advances a clear argument about the
              nation’s Black citizens: not only about the{" "}
            </span>
            <span>
              progress that the nation’s Black citizens had made up to that
              date, but also about the extent of the challenges that remained to
              be addressed.{" "}
            </span>
          </p>
          <p className="pt-10">
            <span>
              ...
              representation of the places where Georgia’s Black citizens
              reside, for example, Du Bois brings together aspects of the bar
              chart and the line chart along with a new form of spiral graph in
              order to give animacy to the presence of Black people in each of
              type of locale. In a later chart, which documents the decrease in
              illiteracy rates in the years between 1860 and 1900, Du Bois makes
              use of what graphic designer Silas Munro describes as a
              “lattice-like arrangement,” in which an otherwise standard bar is
              folded at a right angle in order to further accentuate the
              decreasing rate of illiteracy. Du Bois elaborates upon this
              technique in a later chart, which compares the numbers of Black
              property owners, and the value of their properties, in two Georgia
              cities. Another unique chart in this series, which plots the
              “assessed value of household and kitchen furniture” owned by Black
              Georgians, takes the standard bar chart and bends it into a
              spiral, concentrating the viewer’s focus on the cumulative value
          ...
          <p>
            <span>
              ...
              charts’ custom visual design speaks to an overarching desire, on
              the part of Du Bois, to attend to the specificity of the data and
              its significance for his larger goal.
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              ...
              chart of this series explains, these charts document the upward
              progress of Black Americans in a national and international
              context. They also make use of comparisons to other populations,
              ...
              series begins with several charts focused on population, before
              moving on to explore themes related to employment, education, and
              economics, as well as social, cultural, and religious life.
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              ...
              standard bar charts, pie charts, and line graphs, as well as its
              own creative use of pattern and visual form, the Atlas included,
              for example, a prototypal bump chart that ranked each state
              according to its population; a map that illustrated the spatial
              distribution of the nation’s male population; and another that
              illustrated the spatial distribution of the nation’s Black
              population. (Another chart used area charts in small multiples in
              order compare certain state’s Black and white populations). And
              while race was certainly of concern in the census; indeed, race
              remains one of the lighting rod issues of the census, even
              today—it was not the{" "}
            </span>
          ...
          <p>
            ...
            <span className="font-normal">
              {" "}
              But in their own time, the charts were intended to be viewed as
              part of a carefully curated exhibition experience. Visitors
              entered a small reading room, about 20 feet by 20 feet square, its
              walls painted and ornamented by decorative crown molding, and
              lined with artifacts from floor to ceiling. The books assembled by
              Daniel Murray, of the Library of Congress, filled three shelves of
              under-counter bookcases. On the counters lay more books and some
              of the charts, arranged in a stack for easy perusal. A bronze
              statue of Frederick Douglass was installed on one of the side
              walls, on a pedestal that could swing out from the wall for a 360°
              view. Filling the entire height of the back wall were framed
              artifacts, arranged in three rows: farming tools and other objects
              from Black agricultural and industrial schools, installed in
              swing-out vitrines; the most significant of the charts, installed
              in ornate wooden frames; and alongside them, photographs: over 500
              portraits of the nation’s Black citizens, pictured at school, at
              home, and at work—in other words, in the activities that defined
          ...
          <p>
            <span className="font-normal">
              ...
              after its opening, Du Bois explains that he included the
              photographs to{" "}
            </span>
            <span className="font-normal">
            ...
            <span className="font-normal">
              ...
              analysis of the photographs, art historian Shawn Michelle Smith
              connects them to Du Bois’s idea of double consciousness, “the
          ...
          <p>
            <span className="font-normal">
              ...
              this line of thinking, emphasizing how Du Bois understood double
              consciousness as a “kind of ‘second sight’ that might be
              transformed from a curse into a “gift” that offered a unique and
            ...
            <span className="font-normal">
              ...
              desire, one shared with the photographs, to put the vitality and
              talents of Black America on public display.
            </span>
          </p>
          <p>
            <span className="font-normal">
              ...
              could achieve on its own. While the photographs could document the
              richness of individual lives, they could not picture each one of
              the nation’s Black citizens. Conversely, while the charts could
              present powerful evidence of generalized trends, they could not
              expose the individual people behind the data or the unique stories
              that accompanied each one of their lives. Considered as a
              complementary pair, the charts and the photographs recall another
              visual technology of that era: the stereoscope. The stereoscope
              was a device designed to resolve left- and right-eye views of the
              same image into a single view of additional depth. Similarly, Du
              Bois understood the charts and the photographs as two parts of a
              larger whole. While each was legible on its own, the best and most
              complete picture was gained by viewing them together.
            </span>
          </p>
          <p>
          ...
          <p>
            <span className="font-normal">
              The idea of the charts and the photographs as stereoscopic pairs
              is more than a visual gimmick; it serves as an outward reflection
              of the methodological soul-searching in which Du Bois was, in the
              months leading up to the Paris Exhibition, deeply engaged. When Du
              Bois first arrived in Atlanta, he was heavily invested in
              advancing a quantitative approach to sociological work. As he
              recalls in his 1940 autobiography,{" "}
            </span>
            ...
            <span>
              ...
              “facts”—the more facts the better—when they could be aggregated
              and analyzed in the service of generalized claims.{" "}
            </span>
          </p>
          <p>
            <span className="font-normal">
              But after only a year in the Deep South—and just a few months
              before he began to assemble the materials for Paris Exposition—Du
              Bois experienced what can only be described as an intellectual
              epiphany, one brought about not by any new sociological research
              but instead by his own first-hand evidence of how white supremacy
              overdetermined any and all of the work he might do.{" "}
            </span>
            <span>In </span>
          ...
          <p>
            ...
            <span className="font-normal">
              ...
              Atlanta, on April 23, 1899. Du Bois had first intended to approach
              the incident as he approached any inquiry: through a
              social-scientific lens. He recalls how drafted a “
            </span>
            <span>
              careful and reasoned statement concerning the evident facts” of
              the case, which he sought to publish in the{" "}
            </span>
          ...
          <p>
            <span>
              While Du Bois’s desire to publish a statement on the “facts” of
              the case was extinguished at that point, he continued to
              contemplate—deeply—the larger function of his sociological work.
              As he narrates in{" "}
            </span>
            <span>Dusk of Dawn:</span>
            <span></span>
            ...
            <div className="font-william">
              <p>
                <span>
                  ...
                  and detached scientist while Negroes were lynched, murdered,
                  and starved; and secondly, there was no such definite demand
                  for scientific work of the sort that I was doing. I regarded
                  it as axiomatic that the world wanted to learn the truth and
                  if the truth was sought with even approximate accuracy and
          ...
          <p>
            <span>
              ...
              incident with a greater awareness of the limits of his
              “scientific,” data-driven approach, as well as of the larger
              stakes of any future work he might do. The violence brought about
              by centuries of white supremacy, Du Bois then realized, demanded a
              different scholarly charge: not an emphasis on any particular
              methodology, but instead a broader attempt to describe “the
              truth.” Thus when Du Bois turned to the Paris Exhibition in
              several months’ time, it was this “truth”—the experience and
              effects of living within, and continually resisting, a racist
              regime—that Du Bois sought, through the charts and
            </span>
            <span> </span>
            ...
            <div className="caption text-center mt-10 w-5/6">
              <p>
                <span>
                  ...
                  Owned by Georgia Negroes,” which depicts (among other things)
                  a red ray cutting through the history of Black property
                  ownership. Image courtesy of the Library of Congress, Prints
                  &amp; Photographs Division,{" "}
                </span>
          ...
          <p>
            <span className="font-normal">
              ...
              illustrate the accomplishments of a much smaller group: the
              students of Atlanta University. These students were pictured in
              several of photographs included in the exhibition, along with
              students from other Black universities and industrial schools; but
              their talents and potential were most visible in the second series
              of charts, which were credited not to Du Bois but to “Negro
          ...
          <div className="flex flex-col items-center middle-full">
            ...
            <div className="caption text-center mt-10 w-5/6">
              <p>
                <span>
                  Above: The title image of the second set of charts prepared
                  for the Paris Exposition, “A Series of Statistical Charts
                  Illustrating the Condition of the Descendants of Former
                  African Slaves Now Resident in the United States of America.”
                  Image courtesy of the Library of Congress, Prints &amp;
                  Photographs Division, LC-DIG-ppmsca-08994
                </span>
                <span>.</span>
          ...
          <p>
            <span className="font-normal">
              ...
              Among the defining intellectual contributions of the early years
              of Atlanta University were the Atlanta University Studies, annual
              data-driven reports on specific areas of Black life that were
              presented each spring at a large public conference. In fact, Du
              Bois was recruited to the University in large part to assume
              direction of the studies, which had begun only two years earlier.
              To complete this work, Du Bois drew from “two tiers of volunteer
              researchers,” as sociologist Aldon Morris explains, recent
          ...
          <p>
            ...
            <span className="font-normal">
              ...
              coursework was the mechanism by which Du Bois prepared his
              students for the role they would play after graduation, as
          ...
          <p>
            <span className="font-normal">
              ...
              Studies. The data on Atlanta University graduates that was
              collected for the 1900 report, for example, is the same that is
              visualized in the second series’s opening chart. Thus while the
              specific contributions of individual students remain conscribed to
              the past, we might take the data they together created as an
              invitation to visualize the larger network of the Du Bois-Atlanta
              School of Sociology: the names of Atlanta University students and
              alumni who contributed, in ways large and small, to the program
              that enabled the creation of the charts. This visualization, while
              necessarily imperfect and imprecise, nonetheless helps bear
              witness to the deep infrastructure and broad scope required to
              produce the Paris Exposition charts.
            </span>
          </p>
          <p>
          ...
          <p>
            <span>
              ...
              datasets or to other data visualizations. At the same time, the
              arguments mounted through visualizations of data cannot stand on
              their own; they must be accompanied by additional forms of
              information and methods of presentation, as well as the broader
              context in which they are intended to intervene. Du Bois
              ...
              Exposition, as well as through his writing throughout his life
              about the uses and limits of data.
            </span>
          </p>
          <p>
            <span>
              ...
              current conversations about data in relation to racial justice.
              The topics explored through Du Bois’s charts, such as income level
              and occupational spread, continue to bear witness to the deep
              roots of racism and oppression, as the data journalist and
          ...
          <p>
            <span>
              As scholars and activists turn, once again, to questions of how
              data can be enlisted as “protest,” “accountability,” and
              “collective action,” as the group Data for Black Lives aims to do,
              Du Bois again emerges as a key antecedent—as much for how he
              understood how data and data visualization is complicit in holding
