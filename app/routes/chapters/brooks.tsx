    ...
    >
      ...
      <CenteredLayout>
        ...
        <p className="first-paragraph">
          ...
          of every description chained together," the captives packed in
          quarters "so crowded that each had scarcely room to turn himself."
        ...
        <p>
          By the time that Equiano settled in London, he had been free for over
          a decade; in 1766, Equiano had purchased himself, and therefore his
          freedom, with earnings from his personal trading business. But his
          experience of enslavement was never far from his mind. Thus in the
          late 1780s, as the British antislavery movement began to coalesce,
          Equiano became increasingly involved in its activities. Through these
          activities, he became acquainted with Thomas Clarkson, a leading
          British abolitionist and key member of the London Committee of the
          Society for Effecting the Abolition of the Slave Trade (SEASE). Thus
          in early 1789, when Clarkson received a copy of an image created by
          the Plymouth Committee of SEASE entitled, "Plan of an African Slave
          Ship's Lower Deck with Negroes in the Proportion of Only One to a
          Ton," he knew who he should approach for its first endorsement.
        </p>
        <p>
          In <cite>Committed to Memory: The Art of the Slave Ship Icon</cite>,
          art historian Cheryl Finley imagines how Equiano might have felt as he
          encountered the image for the first time:
        </p>
        <Quotation
          quote={
            <>
              ...
              the wall that divided groups of figures by age and sex might have
              caused him to pause and think about which space he had occupied or
              the people who had lived and died next to him. The combination of
              rows and rows of black figures separated and surrounded by fine
              black lines schematically mapped the space of the hold, marking a
              route to untold horror.
            </>
          }
        />
        <p>
          The route that Finley evokes, the infamous Middle Passage, was what
          Equiano, one year later, writing in his autobiography, would describe
          as "a scene of horror almost inconceivable."
          <InlineFootnote index={1} /> The route was the same that fellow Black
          British antislavery activist, Quobna Ottobah Cugoano, in his own
          treatise,{" "}
          <cite>
          ...
          conveying this horror to his white compatriots. The image would create
          an "instantaneous impression" in "all who saw it" and compel them to
        ...
        <p>
          ...
          result of countless hours of research and design. It also represented
          the culmination of over a century of thinking about data and its
          visual display. Indeed, the idea that evidence could be compiled as
          data and analyzed in terms of its larger significance, its findings
          then distilled into clear and compact visual form, took shape over the
          course of the eighteenth century, guided by (then) new theories about
          how knowledge is produced and perceived.
        </p>
        <p>
          Most historians of data visualization agree about this chronology, as
          well as about the philosophical reorientation that was required for
          the earliest European exemplars of data visualization to begin to
          envision their influential designs.
          ...
          expense of the particularities—and the context—that the data purports
          to represent.
        </p>
        <p>
          ...
          particular visualization always matters—and that context carries with
          it both social and political force. More basically, and more
          profoundly, the "Plan" reminds us that before there are data there are
          people—people who offer up their lives to be counted as data, or have
          their lives counted without their consent. Thus every design process
          must be accompanied by a consideration of the ethical issues
          engaged—both by those who design visualizations and those who perceive
          them as well. In short, the "Plan" epitomizes the necessary trade-offs
          and inherent contradictions involved in visualizing data, those which
          often result in profound human cost. Placing the "Plan" at the center
          of the story that we tell about the emergence of modern data
          visualization thus reminds us of the power—for good and for harm—that
          is involved in a technique that produces new knowledge at the same
          time that it seeks to put that knowledge on view.
        </p>
      </CenteredLayout>

      <ChapterSectionTitle>Origins and Absences</ChapterSectionTitle>
      ...
      <CenteredLayout>
        <p>
          ...
          Ship," nor is there even a definitive version. It is generally agreed
          upon that the idea to create the "Plan" originated with another white
          British abolitionist William Elford, the chairman of the Plymouth
          Committee of SEASE and a veritable polymath. A banker by trade, Elford
          was also an acclaimed painter whose landscapes had shown at the Royal
          Academy of Arts, as well as an amateur scientist whose experiments had
          earned him a Fellowship of the Royal Society, the highest scientific
          honor of the time. Supplementing these skill was domain expertise:
          Elford had family ties to the Royal Navy, and as a result, had early
          access to a report being prepared by one of its naval captains,
          Captain Parrey. Commissioned by British Parliament, Parrey had been
          tasked with investigating the ships docked in Liverpool that were
          involved in the transatlantic slave trade. His research was both
          quantitative and qualitative; in addition to taking precise
          measurements of the ships and scrutinizing muster logs—lists of crew
          members aboard any particular ship—Parrey also interviewed the
          captains and sailors of the ships themselves, learning otherwise
          undisclosed details about the perils faced by crew members aboard
          these ships.
        </p>
        <p>
          ...
          the captains themselves, which indicated the "cargo area and the space
          allotted for the different types of goods to be stowed."
      ...
      <TwoColumnLayout>
        <Column shouldPin={true}>
          <p>
            ...
            more literal depiction of a slave ship, the Marie Séraphique, which
            dates to around 1770. This image, commissioned by the owner of the
            ship, presents{" "}
            <HoverText hoverState="hold">a view of the hold—and</HoverText> the
            captives within it—as one of{" "}
            ...
            —some their arms and legs shackled to each other; others shackled to
            two-by-two.{" "}
          ...
          <p>
            ...
            labeled "store room" are here left blank, even as they were
            assuredly packed with all of the materials required to sustain the
            captives and crew throughout the voyage.
            <InlineFootnote index={7} />
            In Elford's "Plan," however, the white space of the store rooms
            emphasizes its rhetorical point: to call attention to the fact that
            it is people who are packed as cargo on the ship.
          </p>
          <p>
            ...
            lives that are represented only by their incarceration on the ship.
            The "Plan" represents the precise deployment of what Wood describes
            as a "semiotic shock tactic." And yet for all of the power that
            holds, it withholds much more. This has to do with the violence of
            the slave trade that remains unimaginable for those who did not
            experience it. As indicated by both Equiano and Cugoano's remarks,
            the lived experience of the horror of the middle passage, and the
            condition of slavery that it set in motion, can never be
            communicated to those who did not experience it—and even if it could
            be, as Saidiya Hartman and others have argued, it should not be.
            Thus the turn to abstraction in the original image of the "Plan"
            could signify a deliberate choice, on the part of Elford, to use
            abstraction to signify that no amount of description could ever
            accurately represent the truth of the experience that the diagram
            seeks to depict.
          </p>
        </Column>
      ...
      <TwoColumnLayout>
        <Column>
          <p>
            ...
            slave trade. Like Parrey, Clarkston compiled data from the available
            records. He visited merchant halls in order to examine the muster
            rolls stored there, computing mortality rates among the sailors and
            gathering 20,000 of their names. He then sought out
            individuals—primarily sailors who had been mistreated or maimed—who
            could speak from direct experience about the conditions aboard slave
            ships.
          ...
          <p>
            ...
            "Plan" secured what historian Marcus Wood describes as its "graphic
            authority."
      ...
      <ChapterSectionTitle>Enslavement and Abstraction</ChapterSectionTitle>
      ...
      <CenteredLayout>
        <p>
          ...
          Information, Edward Tufte makes the case that QUOTE. But what has gone
          unmentioned in discussions of the history of data visualization is how
          that same conceptual precondition—of the abstraction of complex
          information into more tractable numerical form—was what led to the
          rise of modern capitalism. As Ian Baucom, following Mary Poovey,
          explains, "what distinguishes European modernity's knowledge projects
          (scientific, governmental, and aesthetic) from classical Aristotelian
          models of epistemology—which had bred abstractions from abstractions
          (universals from a priori truths)—is that for European modernity
          abstraction predicates itself on observed particulars, assemblages of
          fact from which abstract reason can never entirely detach itself, and
          whose relation to the abstracting impulse's systematic or universal
          truth claims, Europe's modern philosophical, social, and political
          discourses continuously oblige themselves to theorize."
          <InlineFootnote index={21} />
        </p>
        <p>
          This "will to abstraction, the will to derive systematic knowledges,
          general theories, or any number of the other 'versions of abstraction:
          universals, generalizations, aggregates' from observed particulars,"
          as Ian Baucom, quoting Mary Poovey, explains, … COMPLETE THIS. //
          CONNECT TO RISE OF ABSTRACT PROPERTY, WORK IN QUOTE: Indeed, to the
          extent that the case of the Zong was to help define the struggle
          between slave traders and abolitionists in the late eighteenth
          century, the way in which that struggle was waged suggests that it was
          not only a struggle between competing theories of right (the slaves'
          right to human dignity and the slavers' right to trade), but one
          between competing theories of knowledge, a struggle between an
          empirical and a contractual, an evidentiary and a credible
          epistemology. As such, this struggle both extends and replays what
          scholars in recent years have taken to be the central epistemological
          drama of the long eighteenth century, the drama—emerging from the
          social rivalry of the old landed and the new moneyed classes—in which,
          as mobile property displaced ''real' property, and the imaginary value
          of stocks, bonds, bills-of-exchange, and insured property of all kinds
          increasingly trumped the ''real' value of land, bullion, and other
          tangibles, the concepts of what was knowable, credible, valuable, and
          real were themselves transformed. 16
        </p>
        <p>
          For Baucom and Poovey, as for many others, the Ur example of the "will
          to abstraction" that sustains modern capitalism is slavery. Understood
          in Baucom's terms, slavery becomes the abstraction of human lives into
          their monetary value. This process is no more apparent than in the
          legers of slave ships which abstract the value of their human captives
          into the monetary value of each when sold. And while the creation of
          the Brooks diagram was intended to push back against this violent
          abstraction, it nevertheless engages in its own process of
          abstraction. As Baucom explains, "The print seeks simultaneously,
          dialectically, to turn the empire's disinterested modern science of
          wealth sentimentally against itself by fashioning a visible
          abstraction (an image of what we cannot see) designed not merely to
          account for the trade but to ‘give the spectator an idea of the
          sufferings of the Africans in the Middle Passage, and this so
        ...
        <p>
          ...
          observed particulars that this "visible abstraction" helps to expose,
          and that is how the translation from observed particulars to
          "theories, aggregates, universals, ideas, or any other type of
          abstraction is not reason but fiction or the imagination."{" "}
          <InlineFootnote index={23} /> Clarkson's desire that the diagram will
          "give the spectator an idea of the sufferings of the Africans in the
          Middle Passage" draws upon the viewer's imagination, and their
          sympathy, and not any rational response. In her analysis of Clarkson's
          diagram, she underscores this point: "Despite its graphic flourishes
          and details, this plan was not a realistic representation of the space
          available or the conditions characteristic of a slave ship hold.
          Instead it was an abstraction. As with the Plymouth plan, the
          schematic drawings, easy to grasp and hold in the memory, were
          elaborated by the descriptive text." <InlineFootnote index={24} />
        </p>
        <p>
          Clarkson himself understood as much, writing: "To persons unacquainted
          with the mode of carrying on this system of trading in human flesh,
          these Plans and Sections will appear rather a fiction, than a real
          representation of a slave-ship." But as Finley observes, "Clarkson's
          distinction between a fictional versus a "real representation"
          introduces aesthetic and political debates regarding the imaging and
          imagining of the slave ship that remain in place across the
          nineteenth, twentieth, and twenty-first centuries by shedding light
          upon the formal and thematic inspiration for a vast majority of
          contemporary African American and black diasporic artists. A
          recognition of the enduring significance of white dominant emphases
          upon a literalized and figurative and therefore seemingly authentic or
          "real representation" over and above abstracted and experimental
          representations typically dismissed only as a visual fabrication
          speaks to a white racist terrain characterized by invisibilized black
          histories, narratives, and memories." In a sense, the bodies
          represented in the diagram are not abstracted into monetary currency
          but instead a moral currency—the currency of the white-led
          abolitionist movement. Thus alongside questions about the ethics of
          abstracting lives into data come questions about the ethics of who is
          doing the abstracting, and for whom it is intended to be perceived.
        </p>
      </CenteredLayout>
      ...
      <CenteredLayout>
        <p>
          ...
          through many of the images already familiar to scholars of historical
          data visualization, but it places these images in the context of the
          questions that must accompany them. These questions have to do with
          the source of the data that is included, as well as what is
          deliberately excluded or, alternately, impossible to capture in
          quantitative form. They also have to do with the intended audience for
          the visualization, as well as the intentions of those who design it.
          With these questions in mind, we might turn to another visualization
          designed by Thomas Clarkson, which is also often included in histories
        ...
        <p>
          ...
          significant abolitionist. They are also visualized according to time,
          with horizontal lines indicating efforts that took place before 1650,
          1700, 1740, and 1787, respectively. As the viewer follows the streams
          from top to bottom, in the direct of time, the tributaries converge
          into "two great political rivers, representing the abolitionist
          movement in England and America." <InlineFootnote index={25} />
        </p>
        <p>
          ...
          representation of a social movement which drew strength from countless
          individuals and collectives over an extended period of time. This
          conception must have been known to Clarkson, given his work with the
          London Committee, which he once described as [BODY QUOTE]. And yet, in
          adapting the model of the hydrographic map to the abolitionist
          movement, Clarkson rewrites the history of abolition through what
          Marcus Wood characterizes as "the new, lean, scientific conventions of
          late-eighteenth-century hydrography. Each abolitionist is a clean new
          river with a clear European name," with "Africa off the map"
          altogether. <InlineFootnote index={26} /> Wood's critique calls
          attention to how the colonizing purpose of hydrography and the
          abolitionist diagram are the same: both overtake the territory that is
          pictured—and the people who live there—with the British imperial
          mission. Here, it is not the discovery of new land, but the discovery
          of the horrors of slavery, that were of course already known to those
          who experienced its direct effects. Here, as in the slave ship
          daigram, the question of audience comes to the fore: this chart was
          not designed for those who were enslaved, but for a British viewership
          that sought to valorize its own role in the fight to end slavery.
        </p>
        <p>
          ...
          correlation to the facts. "In many ways there is no rhyme or reason to
          the figures he selects," Wood explains, "his attempt to create a
          self-sufficient cultural history for the cause requires a coherent
          descriptive model which is capable of overriding the heterogeneity of
          the names and writings he has furnished. Clarkson's map imposes order
          on chaos by providing an abolition tree of Jesse. The fruitful loins
          belonging to no single abolitionist but to a mysterious sea, into
          which, in a strange reversal of the generative metaphor, all the
          tributaries pour." <InlineFootnote index={27} />
        </p>
      </CenteredLayout>
      ...
      <TwoColumnLayout>
        <Column shouldPin={true}>
          <p>
            ...
            Cartographies of Time, Daniel Rosenberg and Anthony Grafton position
            Clarkson's diagram as an adaptation of the ideas expressed by the
            German chronologer, Friedrich Strass, who had published his own
            widely circulated "Strom der Zeiten" (Stream of Time) in 1803.
            Strass "believed that a graphic representation of history held
            manifold advantages over a textual one: it revealed order, scale,
            and synchronism simply and without the trouble of memorization and
            calculation," Rosenberg and Grafton explain.{" "}
            <InlineFootnote index={28} /> Translated into multiple languages,
            including English, and widely circulated, Clarkson almost certainly
            saw the chart. Even if he didn't, Clarkson clearly understood how,
            according to the chart's English translator, William Bell, the
            metaphor of the stream "gives greater liveliness to the ideas, and
            impresses events more forcibly on the mind, than the stiff
            regularity of the straight line." <InlineFootnote index={29} />
          </p>
          <p>
            Many scholars, including Grafton and Rosenberg, have made the case
            that chronological charts "cleared the way for statistical graphics"
            by introducing the idea of consistent scale.
      ...
      <TwoColumnLayout>
        <Column>
          <p>
            ...
            history of abolition "before the reader, that he may comprehend the
            whole of it in a single view." This goal is one echoed by Playfair,
            in his Commercial and Political Atlas, and resonates up to the
            present.
          </p>
          <p>
            And yet, placing Clarkson and his abolitionist map at the center of
            the history of data visualization prompts us to ask—always—what this
            single view contains and what it omits, for whom this view will
            benefit, and for whom this view will harm. In the case of the
            ...
            gaxe, and therefore otusideof western history—but not outside of all
            knowledge altogether. Clarkson's image thus accentuates the
      ...
      <ChapterSectionTitle>Diagramming the Present</ChapterSectionTitle>

      <TwoColumnLayout>
        <Column shouldPin={true}>
          <p>
            It is not only in the abstract but in the visible and concrete that
            the slave ship diagram carries through the history of data
            visualization, and into the present. Consider, for example, how the
            inventors of the ISOTYPE icon system, Otto and Marie Neurath,
            incorporated their own isotype icons into a reproduction of the
            diagram in their pamphlet on the history of global trade. (They also
            held a ca. 1800 version of the diagram, created by the German
            printmaker Jacob Xaver Schmunzer, in their personal archive).{" "}
            <InlineFootnote index={33} /> Their icons, like those on the slave
            ship, were intended to serve as abstract representations of observed
            particular—in their case, of the rich complexity of the world's
            population. What's more, they similarly sought to enlist their icons
      ...
      <CenteredLayout>
        <p>
          ...
          people and politics—at the same time that they rejected visualization
          strategies that, they felt, lacked commensurate communicative
          richness. Christopher Burke, the typeface designer and historian,
          believes that the Neuraths probably deliberately chose to exclude
          Playfair from their collection. <InlineFootnote index={34} /> Trained
          as a political economist, Otto Neurath was almost certainly familiar
          with Playfair's work. Less speculative is Marie Neurath's blanket
          critique of time-series charts, quoted by Burke: "Curves are subject
          to much stronger demands for precision than pictorial representation.
          And so it is all the more embarrassing when they do not fulfill these
          demands. A method of statistics that works with countable elements, as
          pictorial statistics does, hardly gives any occasion for error. Its
          advantages are not only educational but also logical."{" "}
          <InlineFootnote index={35} /> Marie Neurath was more correct than she
          could have known, as will be discussed in the next chapter. [ MAYBE
          START NEXT CHAPTER W/ THIS ??? ]
        </p>
        <p>
          ...
          data and its visual display is always political. With this in mind, we
          must work to develop visual typologies that reattach—rather than
        ...
        <p>
          Of course not all data is about people, nor are questions about ethics
          TKTK equally relevant at any particular time. One of the only rules of
          a visualization practice that seeks to attend to the specificity of
          the data is to never say never in design.{" "}
        ...
        <p>
          Taking the lessons of the Brooks, as well as these questions to mind,
          might we visualize additional populations working to combat gun
          violence, or other social harms? How might we honor the people behind
