    ...
    >
      ...
      <TwoColumnLayout>
        <Column>
          ...
          <p>
            ...
            citizens. In her acclaimed recent book, <cite>Dear Science and
            Other Stories</cite>, Black studies scholar Katherine McKittrick
            takes on the project not of history but of science, explaining
            how an account that centers Black people, Black life, and Blackness
            more broadly can reveal the "asymmetrically connected knowledge
      ...
      <CenteredLayout>
        ...
        <p>
          ...
          knowledge is <em>situated</em>, as Haraway would say; or how knowledge is
          <em>relational</em>, as perhaps would McKittrick, does not diminish the
          validity of what we presently know, nor does it foreclose any future
          knowledge-making. On the contrary, these more nuanced understandings of
          the perspectives and places from which knowledge is made are precisely
          those on which, to quote Haraway, "the possibility of sustained, rational,
          objective inquiry rests."
      ...
      <CenteredLayout>
        ...
        <p>
          ...
          Priestley's <cite>New Chart of History</cite>, from 1796, among
          the most circulated charts of its time; and Playfair's
          ...
          efficiency of these charts, but felt that they gave "little sense of the
      ...
      <TwoColumnLayout className="pt-20">
        <Column shouldPin={true}>
          <p>
            ...
            chapter, and by all accounts they were dazzling: triangles and squares of
            ...
            on the floor" and invite her would-be textbook adopters to sit
            around it and contemplate the colors and patterns they perceived.
          ...
          <Quotation
            quote={
              <>
                ...
                day. But I must sell them cheap… To day I
      ...
      <CenteredLayout>
        ...
        <p>
          In addition to advancing a belief in <em>how</em> knowledge is produced,
          Peabody's method advances a belief in <em>who</em>
