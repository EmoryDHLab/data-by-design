                ...
                <div className="space-y-6 left-col col-start-1 col-end-6 2xl:col-end-8 self-center grid grid-cols-7">
                  <p>
                    ...
                    <span>
                      ...
                      contemporary, Anne Laura Clarke, who created her timelines
                      with the help of her sister, also named Elizabeth, to
                      accompany a series of lectures on history which she
                      delivered across the country. Clarke’s charts were not
                      acquired by an archive but instead kept in her sister’s
                      attic, where they remain today.
                    </span>
                    <span>
                      <span role="button" className="circle">
                        32
                      ...
                      <div className="caption text-center mt-10 w-5/6">
                        <p>
                          <span>
                            ...
                            Clarke, as explored by Granville Ganter in his essay
                            on Clarke’s traveling lectures. Right: Another
                            timeline as it was first encountered by Ganter.
                            Photos by Granville Ganter. Courtesy of Granville
                            Ganter.{" "}
                          </span>
                        </p>
                      </div>
                ...
                <div className="space-y-6 left-col col-start-1 col-end-6 2xl:col-end-8 self-center grid grid-cols-7">
                  <p>
                    <span>
                      ...
                      prompted me to undertake a project to reimagine and
                    ...
                    <span>
                      ...
                      involved multiple cohorts of students over multiple years,
                      we first created a touch matrix made of strips of copper
                      tape.
                    </span>
                    <span>
                      <span role="button" className="circle">
                    ...
                    <span>
                      ...
                      and rows of conductive material--in this case, the copper
                      tape--separated by foam spacer. When a person presses on a
                      square of the grid, the two layers of copper tape touch
                      each other, creating a connection. Above the touch matrix
                      sits a cloth topper, also fabricated by members of the
                      lab, that approximates the visual features of Peabody’s
                      original charts.
                    </span>
                    <span>
                      <span role="button" className="circle">
                    ...
                    <span>
                      ...
                      individually addressable LEDs, resulting in a 30 x 30 grid
                      that can be programmed to display Peabody’s “painted
                      centuries,” as she sometimes described them.
                    </span>
                    <span>
                      <span role="button" className="circle">
                        36
                    ...
                    <span>
                      {" "}
                      While Peabody used a stick to point to specific events on
                      the grid, the Floor Chart responds to touch; users can
                      press on individual squares in order to cycle through the
                      possible colors of each chart, allowing them to engage
                      their whole bodies in the creation of chronological charts
                      of their own.
                    </span>
                  </p>
                  <p>
                    <span>
                      ...
                      electronics prototyping to signal processing to circuit
                      board design. It has also required a truly tremendous
                      amount of labor. Each yard-long strip of copper tape
                      needed to be perfectly aligned, lest a small misalignment
                      at one end result in a significant gap at the other. Each
                      of the nine-hundred square-shaped holes of the membrane
                      layer of the touch matrix was required to be cut out by
                      hand, as laser-cutting the holes would have released
                      harmful toxins. Each electrical connection was required to
                      be soldered, tested, and then—in almost all cases—soldered
                      again, so as to ensure that the circuit remained intact.
                      As much as an exercise in physical fabrication, the
                      project has become an exercise in the physicality of work
                      itself—of the focus that is required, and the resultant
                      fatigue, of any large-scale project that is made by human
                      hands.
                    </span>
                  </p>
                </div>
                  ...
                  <div className="space-y-6 right-col col-span-full col-start-7 2xl:col-start-8 self-center grid grid-cols-7">
                    <div className="flex flex-col items-center middle-full">
                      ...
                      <div className="caption text-center mt-10 w-5/6">
                        <p>
                          <span>
                            The layers of the touch interface, built with copper
                            tape and a foam spacer; the assembled touch
                            interface; a view of the modular circuit boards for
                            communicating with the LEDs; a rendering of the
                            completed Floor Chart; the LEDs displayed on top of
                            the quilted chart. Photos by Lauren Klein.
                          </span>
                        </p>
                      </div>
                    </div>
