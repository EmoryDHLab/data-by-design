...
const events: Event[] = [
  {
    ...
    kind: "conversation",
    description: "A conversation with the authors, moderated by Catherine D'Ignazio (MIT)",
    city: "Decatur, GA",
  ...
  },
  {
    ...
    title: "Book party at the American Studies Association conference",
  ...
  },
  {
    ...
    kind: "conversation",
    description: "A conversation with the authors, moderated by Shannon Mattern (New York Library Council)",
    city: "New York, NY",
  ...
  },
  {
    ...
    kind: "workshop",
    description: "A talk and workshop by Tanvi Sharma",
  ...
  },
  {
    ...
    kind: "conversation",
    description: "Lauren Klein in conversation with Arvind Satyanarayan (MIT)",
    city: "Boston, MA",
  ...
  },
  {
    ...
    weekday: "Fri",
    year: "2027",
    title: "Book party at the Modern Langauge Association conference",
