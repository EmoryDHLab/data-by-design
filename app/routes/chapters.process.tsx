...
import PeabodySandbox from "~/components/process/PeabodySandbox";
import FootnotesList from "~/components/FootnotesList";
import Scrollytell from "~/components/process/PeabodyScrollytell";
import Quotation from "~/components/Quotation";
import Quiz from "~/components/process/quiz/Quiz";
import PeabodyBarGraph from "~/components/process/PeabodyBarGraph";
import LEDChart from "~/components/process/LEDChart";
import figures from "~/data/figures/process.json";
...
export default function PeabodyPage() {
  ...
  return (
    <ChapterContext.Provider
      value={{
        backgroundColor: "processPrimary",
        accentColor: "processSecondary",
