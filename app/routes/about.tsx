        ...
        <TwoColumnLayout>
          ...
          <Column className="px-3">
            <p className="pt-16 first-paragraph">
              ...
              states, and four institutions.
            </p>

            <span className="font-normal">
              <p className="py-2">
                <span className="font-medium"> Lauren Klein </span> (Emory,
                Departments of Quantitative Theory & Methods and English) is the
                director of the project and conducted the historical and
                archival research for the project. She also wrote the text that
                appears on the site.
              </p>
              <p className="py-2">
                ...
                site-wide and page-specific interactions, as well as the custom
                visualizations that appear on the site.
              </p>{" "}
              <p className="py-2">
                <span className="font-medium"> Jay Varner </span> (Emory, Center
                for Digital Scholarship) is the current lead developer on the
                project. He implemented many of the project’s interactive
                components, including the scrollytell mechanism that appears
                throughout the site.{" "}
              </p>
              <p className="py-2">
                {" "}
                ...
                visualizations and other interactive features that appear on the
                front page as well as in the Du Bois chapter. He also led the
              ...
              <p className="py-2">
                <span className="font-medium">Jianing Fu </span> (Georgia Tech,
                BS ‘21, Computer Science, Univ. of California, Berkeley, MEng
                ‘22, Computer Science) built the components on the project’s
                front page, including the interactive timeline, for the project
