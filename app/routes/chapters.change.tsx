      ...
      <ChapterBody>
        ...
        <TwoColumnLayout>
          ...
          <Column shouldPin className="md:p-10">
            <Figure figure={figures["0503-georgia"]} />
          </Column>
        </TwoColumnLayout>
        ...
        <CenteredLayout>
          ...
          <Figure
            figures={[
              figures["0506-866-population"],
              figures["0507-877-schools"],
              figures["0508-881-land"],
            ]}
          ...
          <Figure figure={figures["0509-value"]} />
