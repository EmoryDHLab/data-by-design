      ...
      <ChapterBody>
        ...
        <TwoColumnLayout>
          ...
          <Column shouldPin className="md:p-10">
            {/* <HoverImages1 /> */}
            <Figure figure={figures["863"]} />
          </Column>
        </TwoColumnLayout>

        <CenteredLayout>
          <Figure
            figures={[figures["866"], figures["877"], figures["881"]]}
          ...
          <Column>
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-8 md:ml-24">
              <Figure
                ...
                showCaption={false}
              />
              <Figure figure={figures["0512-alt"]} showCaption={false} />
              <Figure
            ...
            <figcaption className="font-neueMontreal text-xs md:text-sm leading-5 text-left mt-3 md:mt-6 mb-6 md:mb-12 col-span-full">
              ...
              States; a visually similar chart of mariage statistics of all
        ...
        <CenteredLayout>
          ...
          <Figure
            figure={figures["0520-2-BlackHistoryDataVis1"]}
            className="mx-2 md:mx-12 text-sm md:text-base"
          />
          <Figure
            figure={figures["0521-2-BlackHistoryDataVis4"]}
          ...
          <Figure
            figure={figures["0522-dignity-and-debt"]}
            className="mx-2 md:mx-12 text-sm md:text-base"
        ...
        <ScrollytellOne
          triggers={[
            ...
            >
              <img
                src="https://iip.ecds.io/iiif/2/0516-master-pnp-ppmsca-08700-08778u.tiff/99,1472,1399,329/full/0/default.jpg"
                alt=""
              />
            </span>,
        ...
        <CenteredLayout>
          ...
          <Figure
            className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 items-baseline"
            figures={[figures["0527-899-series"], figures["0526-data-table"]]}
            groupCaption={
              <p>
                Left: {figures["0527-899-series"].caption} Right:{" "}
