    ...
    >
      ...
      <CenteredLayout>
        ...
        <TwoColumnLayout>
          <Column shouldPin={true}>
            ...
            Elizabeth Palmer Peabody was born in 1804, within only a year or two of Shanawdithit. But her life circumstances—the stability of food and family, her membership in the Boston intellectual elite, and the gift of good health—enabled her to live for nearly a century. By the time that she died, in 1894, she left her mark on any number of fields. But in the early 1850s, at the prime of her life, Peabody set out from her home in Boston to ride the rails. She traveled as far north as{" "}
              ...
              order to promote the pair of history textbooks she had recently written, {" "}<cite>The Polish-American System of Chronology</cite>{" "} (1850) and {" "}<cite>A Chronological History of the United States</cite>{" "} (1856). In the textbooks, Peabody described a new method of visual learning—the Polish-American system, she came to call it—a method with data visualization at its core. 
            </p>
            <p>
            Today, Peabody is still most widely recognized for her proximity to more famous men—in particular, to the writers of the American Renaissance, such as Ralph Waldo Emerson and Nathaniel Hawthorne, and to early champions of educational reform, such as Bronson Alcott and Horace Mann. <InlineFootnote index={0} />  She is certainly not accorded a prominent place in any major history of data visualization. But her contributions to each of these areas, including visualization, were substantial. The bookstore that she ran out of her home, at Boston's 13 West Street, functioned as the de facto salon for the transcendentalist movement. She edited and published the first version of Henry David Thoreau's essay on civil disobedience. She can be credited with starting the first kindergarten in the United States. And, as this chapter will assert, she offered a transformative view of the uses and value of data visualization, one which challenges the teleological account of the field's emergence, as well as the epistemological assumptions that—as a result of this account—have become embedded in the field.  <InlineFootnote index={1} />  
            </p>
          </Column>
          <Column shouldPin>
            <PromotionalTourMap />
        ...
        <CenteredLayout>
          ...
          <p>
          In {" "}<cite>The Polish-American System of Chronology</cite>{" "}, Peabody covers a tremendous expanse of time: the period between 2500 BCE and the present (1849 CE). But Peabody also saw the need for a textbook that focused exclusively on the United States, and that went into more detail than she could cover in a textbook on world history. And so, shortly after the release of the {" "}<cite>Polish-American System</cite>, she began working on the book that would be published, in 1856, as {" "}<cite></cite>A Chronological History of the United States</cite>. This textbook contained the four full-color plates displayed above; one for each of the centuries since the first European colonizers set foot on Native American land. As Peabody envisioned it, the basic exercise was to read a chapter of the textbook, which contained a narrative account of the events of a single century, and then match each item in the list of events that concluded the chapter with its visual representation on the corresponding chart.
          </p>
        </CenteredLayout>
        ...
        <TwoColumnLayout>
          <Column>
            ...
            <p>
              ...
              of a liberatory Black science to unfold. But the truth is that all of our ways of knowing are shaped by asymmetrical power, and data visualization is no exception. We have already seen a related argument in Chapter One, which engaged feminist philosopher Donna Haraway's ideas about the “god trick.” <InlineFootnote index={13}></InlineFootnote>  Crucially for Haraway, as for McKittrick, our awareness of how knowledge is <em>situated</em>, as Haraway would say (or how knowledge is <em>relational</em>, as perhaps would McKittrick), does not diminish the validity of what we presently know, nor does it foreclose any future knowledge-making. <InlineFootnote index={14}></InlineFootnote> On the contrary, these more nuanced understandings of the perspectives and places from which knowledge is made are precisely those on which, to quote Haraway, “the possibility of sustained, rational, objective inquiry rests.” <InlineFootnote index={15}></InlineFootnote> 
            </p>
          </Column>
        ...
        <TwoColumnLayout>
          <Column>
            ...
            />
            <p>
            Peabody’s goal with the Polish-American system was to create a framework, equal parts pedagogical and epistemological, through which this difficult thinking could take place. “The old world is covered with bad institutions which men have created, very often with positively good intentions, but on false notions, or, at least, without large and profound ideas,” she explains in the preface to the <cite>Chronological History</cite>. “Whether the new world shall estimate and sift out these evils, or repeat these mistakes, depends on young Americans, who are now sitting in schoolrooms all over the country, unconscious of their powers and consequent responsibilities.”
              <InlineFootnote index={22}></InlineFootnote>
              Her hope was that the act of creating the chronological charts, rather than simply studying them, would prompt both self-reflection and new ideas. Put another way: Peabody hoped that by prompting her students to create new narratives of the past, they would also imagine alternative possible futures.
            </p>
            <p>
        ...
        <CenteredLayout>
          ...
          <p>
            ...
            visual form, Peabody nevertheless identified Willard as a major
            ...
            As for Willard, her stated influences included Joseph
            Priestley's <cite>New Chart of History</cite>, from 1796, among the
            most circulated charts of its time; and Playfair's
            <cite>Commercial and Political Atlas</cite>, which we have already discussed in depth. According to historian Susan Schulten, Willard appreciated the
            efficiency of Playfair's charts, but felt that they gave "little sense of
            the
            <em>dimension,</em> such as the relative importance of periods or
            the subjective experience of time."
            <InlineFootnote index={25}></InlineFootnote>
            From our vantage in the present, it is still safe to say that Playfair's import-export charts do not provide a sense of the subjective experience of time. But they remain just as interpretable today as they were at the time of their making—one of Playfair's primary aims, as you might recall. 
          </p>
          <p>
          By contrast, the more abstract impression first conveyed by Peabody's chronological grids requires additional interpretation. Her configuration of her data not according to the cartesian grid (<em>pace</em> Playfair) but instead as a visual text, designed to be read from left to right, top to bottom, underscores her interpretive intent. (What might seem to be x-y axes that divide each image into quadrants are instead, as Peabody explains, only intended to serve as visual anchor points in an otherwise unstructured field.) This, too, was intentional. Peabody designed her charts to serve as the basis for future knowledge, rather than that knowledge's definitive source. 
          </p>
          <p>
        ...
        <TwoColumnLayout>
          <Column>
            ...
            The pedagogical impact of this embodied interaction was, as best we can gather, nothing short of transformative. “I have never known a system which placed the events of the history of all nations before the mind with such clearness, so little confusion, and so much permanency,” wrote Eliphalet Nott, then president of Union College, who participated in one of Peabody's teaching demonstrations.  
              ...
              Anticipating a decidedly twenty-first-century view of the value of data visceralization, Peabody staged an encounter with the data that involved the whole body. This was an interaction that, she hoped, would in turn stimulate the imagination to new heights. Indeed, if visualization is to continue to offer “richer understandings [of data] that enable researchers to ask bolder questions,” as esteemed visualization researcher Ben Shneiderman asserts, then the mural chart seems to represent an early apotheosis.
              <InlineFootnote index={29}></InlineFootnote>
            </p>
            <p>
            And yet, because the mural charts were not valued as objects of knowledge in their own time, not a single one has been preserved.  
              <InlineFootnote index={30}></InlineFootnote>
              Scholars even remain uncertain as to many of their basic features. Peabody's biographer, Bruce Ronda, speculates that they “must have been much larger than even folio size.”
              <InlineFootnote index={31}></InlineFootnote>
              And while he does not provide any more specificity, Peabody's nephew Julian's recollection of the “huge, colored charts” which “hung on the walls of our sitting room” offers a first-hand account of the impression they made.
              <InlineFootnote index={32}></InlineFootnote>
              As an additional datapoint, one might consider the “poster-sized timelines” created by Peabody's contemporary, Anne Laura Clarke, who created her timelines with the help of her sister, also named Elizabeth, to accompany a series of lectures on history which she delivered across the country. (Clarke's charts were not acquired by an archive but instead kept in her sister's attic, where they remain today. )
        ...
        <TwoColumnLayout>
          <Column shouldPin={true}>
            <p>
            The absence of Peabody's mural charts from the archive prompted me to reimagine Peabody's embodied pedagogy for the present.  
              <InlineFootnote index={34}></InlineFootnote>
              Working with my research group, in a team that involved multiple cohorts of students over multiple years, we first created a three-foot by three-foot touch matrix made of strips of copper tape.
        ...
        <CenteredLayout>
          ...
          <p>
            ...
            of Gee's Bend for centuries, both for their formal features and for the
