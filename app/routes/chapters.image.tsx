...
import ProjectTimelineScrollytell from "~/components/image/projectTimeline/ProjectTimelineScrollytell";
      ...
      <ChapterBody>
        ...
        <TwoColumnLayout>
          ...
          <Column className="md:ml-12" shouldPin={true}>
            <Figure
              figure={figures["0206-playfair-table-america-rect-cropped"]}
            />
            <Figure
              figure={figures["0207-playfair-table-northam-rect-cropped"]}
            />
          </Column>
        </TwoColumnLayout>
        ...
        <TwoColumnLayout>
          ...
          <Column shouldPin>
            <Figure figure={figures["0211-upscale"]} />
          </Column>
        </TwoColumnLayout>
        <TwoColumnLayout>
          <Column>
          ...
          <Column shouldPin>
            ...
            <Figure figure={missing("0214-activeshooters")} />
          </Column>
        </TwoColumnLayout>
